...
*/
public class get_disease_common {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					get_disease_common window = new get_disease_common();
	...
	void disp()
	{
		...
		model.setRowCount(0);
		model.addRow(new Object[]{"DIID", "Name", "No. of patients"});
		//System.out.println("Afafd");
		i=0;
		while(i<diid.size() && i<10)
		{
			model.addRow(new Object[] {diid.get(i), disease_name.get(i), count_patients.get(i)});
			i++;	
		}
		//for(i=0;i<10;i++)
