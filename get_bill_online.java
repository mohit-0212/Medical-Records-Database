...
public class get_bill_online {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					get_bill_online window = new get_bill_online();
	...
	void handle_query() {
	      try (Connection conn = DriverManager.getConnection(
	         ...
	         String query = "select bno,bname,bdate from bill where payment_mode = \"online\"";
