...
public class inserts {
	public void medicine(String name, String mid,  String price, String stock) {
	...
	public void disease(String name, String category,  String diid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void doctor(String did, String name,  String phone_no) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void patient(String pid, String name,  String complain, String date_admitted, String date_discharged, String birthdate) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void operation(String opid, String opname,  String description) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void bill(String bno, String bname,  String bdate, String payment_mode) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void tests(String tid, String name) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void surgeon(String did, String sid, String specialization) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void department(String dept_id, String name) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void cures(String mid, String diid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void prescribes_m(String did, String mid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void consults(String did, String pid, String date) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void takes_m(String mid, String pid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void takes_t(String pid, String tid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void conduct(String opid, String tid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void performs_t(String sid, String tid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void performs_o(String sid, String opid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void pays(String pid, String bno) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void belongs_to(String did, String dept_id) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void presides(String did, String dept_id, String date) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void offers(String dept_id, String opid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void is_a(String did, String sid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void prescribes_o(String did, String tid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
	...
	public void has(String pid, String diid) {
		try (Connection conn = DriverManager.getConnection(
	            "jdbc:mysql://localhost:3306/newdbms?useSSL=false", "root", "akhil");
	      Statement stmt = conn.createStatement();) {
