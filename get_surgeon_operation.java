...
public class get_surgeon_operation {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					get_surgeon_operation window = new get_surgeon_operation();
	...
	void disp()
	{
		...
		model.setRowCount(0);
		model.addRow(new Object[]{"SID", "Name", "No. of operations"});
		//System.out.println("Afafd");
		i=0;
		while(i<sid.size() && i<10)
		{
			model.addRow(new Object[] {sid.get(i), surg_name.get(i), count_ops.get(i)});
			i++;	
		}
		//for(i=0;i<10;i++)
