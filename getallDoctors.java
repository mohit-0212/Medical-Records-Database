...
public class getallDoctors {
	...
	public ArrayList<String> phone_no = new ArrayList<>();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					getallDoctors window = new getallDoctors();
	...
	void handle_query() {
	      try (Connection conn = DriverManager.getConnection(
	         ...
	         while(rset.next()) { 
	        	...
	        	did.add(String.valueOf(rset.getInt("did")));
	            name.add(rset.getString("name"));
	            phone_no.add(rset.getString("phone_no"));
	            	         }	 
	...
	void disp()
	{
		...
		model.setRowCount(0);
		model.addRow(new Object[]{"DID", "Name", "Phone no."});
	...
	private void initialize() {
		...
		JLabel lblAllPatientsInformation = new JLabel("ALL DOCTORS INFORMATION");
