...
public class get_com_operation {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					get_com_operation window = new get_com_operation();
	...
	void disp()
	{
		...
		model.setRowCount(0);
		model.addRow(new Object[]{"OPID", "Name", "No. of operations"});
		//System.out.println("Afafd");
		i=0;
		while(i<opid.size() && i<10)
		{
			model.addRow(new Object[] {opid.get(i), operation_name.get(i), count_ops.get(i)});
			i++;	
		}
		//for(i=0;i<10;i++)
